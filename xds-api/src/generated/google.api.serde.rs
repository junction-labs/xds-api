...
impl serde::Serialize for Http {
        ...
        S: serde::Serializer,
    {
        ...
        if self.fully_decode_reserved_expansion {
            struct_ser.serialize_field("fully_decode_reserved_expansion", &self.fully_decode_reserved_expansion)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for HttpRule {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.response_body.is_empty() {
            struct_ser.serialize_field("response_body", &self.response_body)?;
        }
        if !self.additional_bindings.is_empty() {
            struct_ser.serialize_field("additional_bindings", &self.additional_bindings)?;
        }
