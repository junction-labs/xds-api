...
impl ::prost::Name for AwsIamConfig {
    const NAME: &'static str = "AwsIamConfig";
    const PACKAGE: &'static str = "envoy.config.grpc_credential.v3";
    fn full_name() -> ::prost::alloc::string::String {
        "envoy.config.grpc_credential.v3.AwsIamConfig".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/envoy.config.grpc_credential.v3.AwsIamConfig".into()
    }
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
